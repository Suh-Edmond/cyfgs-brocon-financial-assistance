...
<div>
    <h6
        ...
        <span style="padding-right: 5px;"></span> Income
    </h6>
</div>
...
<div style="margin-top: 3rem">
    <h6
        style="font-weight: bold;font-size: .7rem; text-align:center;text-transform: uppercase;padding-bottom: 20px;text-decoration: underline">
        <span style="padding-right: 5px;"></span> Expenditures/Disbursements
    </h6>
</div>
    ...
    <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
        ...
        @for($i = 0; $i < count($value->items); $i++)
            <tr style="padding: 13px;border: 1px solid black; font-size: smaller;">
                ...
                <td style="padding: 5px; border: 1px solid black;">{{number_format($value->items[$i]->amount_spent)}}
                </td>
                <td style="padding: 5px; border: 1px solid black;"></td>
                <td style="padding: 5px; border: 1px solid black;"></td>
            </tr>
...
<div style="margin: 10px 3rem 50px;">
    <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
        <tr style="border: 1px solid black; font-size: smaller">
            ...
            <td style="padding: 5px;font-weight: bold;border: 1px solid black; text-align: center">
                {{number_format($total_income)}} XAF </td>
        </tr>
        <tr style="border: 1px solid black; font-size: smaller">
            <td style="padding: 5px; border: 1px solid black;">
                S2
            </td>
            <td style="padding: 5px;font-weight: bold;border: 1px solid black; text-align: center">Total Expenditure
            </td>
            <td style="padding: 5px;font-weight: bold;border: 1px solid black; text-align: center">
                {{number_format($total_expenditure)}} XAF </td>
        </tr>
        <tr style="border: 1px solid black; font-size: smaller">
            <td style="padding: 5px; border: 1px solid black;">
                S3
