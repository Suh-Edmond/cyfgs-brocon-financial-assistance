        ...
        <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
            ...
            @foreach ($contributions as $key => $contribution)
                <tr style="border: 1px solid black; font-size: smaller">
                    ...
                    <td style="border: 1px solid black; padding: 11px; text-align: center" >{{ isset($contribution->month_name)?$contribution->month_name: 'N/A' }}</td>
                    <td style="border: 1px solid black; padding: 11px; text-align: center" >{{ isset($contribution->quarterly_name) ? $contribution->quarterly_name:  'N/A' }}</td>
                    <td style="border: 1px solid black; padding: 11px; text-align: center" >{{ isset($contribution->session->year)? $contribution->session->year: \App\Models\Session::find($contribution->session)->year }}</td>
