...
<div>
    <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
        ...
        <tr style="border: 1px solid black; font-size: smaller">
            ...
            <td style="border: 1px solid black; padding: 3px; text-align: center">{{ $contribution->user_name }}</td>
            <td style="border: 1px solid black; padding: 3px; text-align: center">
                {{ number_format($contribution->total_amount_deposited) }}</td>
            <td style="border: 1px solid black; padding: 3px; text-align: center">
        ...
        <tr style="padding: 12px; border: 1px solid black; font-size: smaller">
            <td style="border: 1px solid black;text-align: center; padding: 1px;font-weight: bold" colspan="2"> /
            </td>
            <td style="padding: 3px;font-weight: bold;border: 1px solid black; text-align: center">{{
                number_format($total_deposited_users) }} XAF </td>
            <td style="padding: 3px;font-weight: bold;text-align: center">{{ number_format($total_balance_users) }} XAF
            </td>
        </tr>
    </table>
</div>
...
<div style="margin-top: 4px;">
    @if($paymentItem->frequency == \App\Constants\PaymentItemFrequency::MONTHLY || $paymentItem->frequency ==
    \App\Constants\PaymentItemFrequency::QUARTERLY)
