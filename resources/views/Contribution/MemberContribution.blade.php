...
<div>
    <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
        ...
        <tr style="border: 1px solid black; font-size: smaller">
            ...
            <td style="border: 1px solid black; padding: 3px; text-align: center">{{ $contribution->quarterly_name }}
            </td>
            ...
            @else
            <td style="border: 1px solid black; padding: 3px; text-align: center">{{ str_replace('_', ' ',
                $contribution->payment_item_frequency) }}</td>
            @endif
            ...
            <td style="border: 1px solid black; padding: 3px; text-align: center">{{ date('d-m-Y',
                strtotime($contribution->created_at)) }}</td>
