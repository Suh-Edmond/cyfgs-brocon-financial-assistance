    ...
    <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
        ...
        <tr style="border: 1px solid black; font-size: smaller">
            ...
            <td style="border: 1px solid black; padding: 3px;text-align: center">{{
                number_format($user_saving->amount_deposited) }}
            </td>
            <td style="border: 1px solid black; padding: 3px;text-align: center">{{
                number_format($user_saving->amount_used) }}
            </td>
            <td style="border: 1px solid black; padding: 3px;text-align: center">{{ $user_saving->approve }}</td>
            <td style="border: 1px solid black; padding: 3px;text-align: center">{{
                number_format(($user_saving->amount_deposited) - ($user_saving->amount_used)) }}
            </td>
            <td style="border: 1px solid black; padding: 3px;text-align: center">{{ date('d-m-Y',
                strtotime($user_saving->created_at)) }}</td>
