    ...
    <div>
        <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
            ...
            <tr style="padding: 12px; border: 1px solid black; font-size: smaller">
                <td style="border: 1px solid black;text-align: center; padding: 1px;font-weight: bold" colspan="{{$col_span}}">Tally
                </td>
                <td style="padding: 3px;font-weight: bold;border: 1px solid black; text-align: center">{{ number_format($yearly_expected) }} XAF </td>
                <td style="padding: 3px;font-weight: bold;border: 1px solid black; text-align: center">{{ number_format($yearly_total) }} XAF </td>
                <td style="padding: 3px;font-weight: bold;text-align: center">{{ number_format($year_balance) }} XAF </td>
            </tr>
        </table>
    </div>
