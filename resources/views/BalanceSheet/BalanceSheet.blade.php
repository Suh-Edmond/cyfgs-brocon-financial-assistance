...
<div style="margin-left: 3rem; margin-right: 3rem">
    <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
        ...
        <tr style="padding: 12px; border: 1px solid black; font-size: smaller">
            <td style="border: 1px solid black;text-align: center; padding: 1px;font-weight: bold;font-size: .8rem"
                colspan="{{$col_span}}">Tally
            </td>
            ...
            <td style="padding: 3px;font-weight: bold;border: 1px solid black; text-align: center;font-size: .8rem">{{
                number_format($yearly_expected) }} </td>
            <td style="padding: 3px;font-weight: bold;border: 1px solid black; text-align: center;font-size: .8rem">{{
                number_format($yearly_total) }} </td>
            <td style="padding: 3px;font-weight: bold;text-align: center;font-size: .8rem">{{
                number_format($year_balance) }} </td>
        </tr>
    </table>
</div>
...
<div style="margin: 10px 3rem 50px;">
    <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
        ...
        <tr style="border: 1px solid black; font-size: smaller">
            ...
            <td style="padding: 3px; border: 1px solid black;">
                {{ str_replace('_', ' ', $colum->type)}}
            </td>
            <td style="padding: 3px; border: 1px solid black;">
                {{ str_replace('_', ' ', $colum->frequency)}}
            </td>
            <td style="padding: 3px; border: 1px solid black;">
                {{number_format($colum->amount)}} XAF
            </td>
            <td style="padding: 3px; border: 1px solid black;">
                {{\App\Constants\Constants::SAVINGS == $colum->type ? 0 : number_format($colum->total_expect_amount)}}
                XAF
            </td>
            <td style="padding: 3px; border: 1px solid black;">
                {{\App\Constants\Constants::SAVINGS == $colum->type ? 0 :
                number_format($colum->total_amount_deposited)}} XAF
            </td>
            <td style="padding: 3px; border: 1px solid black;">
                {{\App\Constants\Constants::SAVINGS == $colum->type ? 0 : number_format(($colum->total_expect_amount -
                $colum->total_amount_deposited))}} XAF
            </td>
            <td style="padding: 3px; border: 1px solid black;">
...
<div style="margin: 10px 3rem 50px;">
    <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
        ...
        <tr style="border: 1px solid black; font-size: smaller">
            ...
            <td style="padding: 4px;font-weight: bold;border: 1px solid black; text-align: center">{{
                number_format($yearly_expected) }} XAF </td>
            <td style="padding: 4px;font-weight: bold;border: 1px solid black; text-align: center">{{
                number_format($yearly_total) }} XAF </td>
...
<div class="president" style="text-align: center;margin-top: 40px">
    <div>
        ...
        <div class="border_line"
            style="border-bottom: 1px solid black; margin-top: 10px;margin-left:35rem;text-align: center">
        </div>
    </div>
</div>
<!------------------------------------------------------END OF PRESENTERS-------------------------------------------------------------------------------------->
