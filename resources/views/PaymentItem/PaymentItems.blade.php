        ...
        <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
            ...
            @foreach ($payment_items as $key => $value)
                <tr style="border: 1px solid black; font-size: smaller">
                   ...
                   @endif
                    <td style="border: 1px solid black; padding: 3px;font-size: smaller">{{ str_replace('_', ' ', $value->frequency) }}</td>
                    <td style="border: 1px solid black; padding: 3px;font-size: smaller">{{ str_replace('_', ' ', $value->type) }}</td>
