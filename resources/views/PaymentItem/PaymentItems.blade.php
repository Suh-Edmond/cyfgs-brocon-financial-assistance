...
<div>
    <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
        ...
        <tr style="border: 1px solid black; font-size: smaller">
            ...
            @endif
            <td style="border: 1px solid black; padding: 3px;font-size: smaller">{{ str_replace('_', ' ',
                $value->frequency) }}</td>
            <td style="border: 1px solid black; padding: 3px;font-size: smaller">{{ str_replace('_', ' ', $value->type)
                }}</td>
        ...
        <tr style="border: 1px solid black; font-size: smaller">
            ...
            <td style="border: 1px solid black; padding: 3px;font-weight: bold" colspan="5">{{ number_format($total) }}
                XAF</td>
